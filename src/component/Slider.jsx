  ...
  return (
    <div className="w-full select-none">
      ...
      >
        ...
        <div className="absolute py-2.5 md:left-10 lg:left-20 left-5 top-5 lg:top-1/4  capitalize text-sky-500 text-xs sm:text-sm md:text-xl font-semibold text-center leading-4">
          Kyoai medical services
        </div>
        <div className="max-w-xs lg:max-w-lg absolute block md:left-10 lg:left-20 left-5 top-[32%] capitalize text-sky-500 text-xs sm:text-lg md:text-4xl lg:font-black lg:text-6xl font-bold text-left leading-4">
          <h1>YOUR HEALTH</h1>
          <p>IS OUR PRIORITY</p>
